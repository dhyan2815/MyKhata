...
// Enhanced Register component for user registration
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Welcome to MyKhata! Registration successful');
  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta name="description" content="Join MyKhata and start managing your finances with smart budgeting tools and receipt scanning." />
      </Helmet>
        ...
        >
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-600">Smart categorization</div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-8 z-20">
            <div className="text-white">
              <h3 className="text-2xl font-bold mb-2">Join MyKhata for Free Today</h3>
